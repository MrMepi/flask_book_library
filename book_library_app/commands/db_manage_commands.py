...
@db_manager_bp.cli.group()
def db_manage():
    """Databases management commands"""
    pass

@db_manage.command()
def add_data():
    """Add sample data to satabase"""
    try:
        ...
        db.session.commit()
        print('Data has been successfully added to databases')
...
def remove_data():
    ...
    try:
        ...
        db.session.commit()
        print('Data has been successfully remove from databases')
    except Exception as exc:
        print("Unexpected error: {}".format(exc))
